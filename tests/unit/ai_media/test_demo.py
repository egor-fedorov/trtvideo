...
from ai_media.cli.demo import build_parser
...
from ai_media.demo.media import build_demo_input_command, validate_demo_probe
from ai_media.demo.workflow import upscale_command
